...
- **JavaScript / Node.js / TypeScript** — ngôn ngữ CHÍNH hằng ngày (toàn bộ app
  ...
  không TS._
- **Python** — scripting, async, ML (churn/classify trong [[crm]]), data. Note:
  [[python-asyncio-blocking]], [[asyncio-gotchas]].

## Hướng học thêm (chưa dùng nhiều ở công việc thật)

- **Rust** — an toàn bộ nhớ, systems programming (sở thích/học sâu). Note:
  [[rust-ownership]], [[borrow-checker]].
- **Java** — luyện thuật toán, xem [[dsa]].
