...
- [✅ 2026-08-17] Comment lỗi thời ở `packages/scripttag/src/customerPortal/managers/CustomerPortalManager.js:40-43`
...
- [✅ 2026-08-17] Nút preview vừa disabled vừa quay spinner
...
- [✅ 2026-08-19] Check CLS giúp tôi gần đây đang bị cao hơn mức shopify accept là good rồi nhé!!
...
- [✅ 2026-08-19] **[P0]** Fix CLS Home — bỏ đảo thứ tự card khi `metricsFirst` đổi
...
- [✅ 2026-08-19] **[P0]** Fix CLS gốc — `SET_SHOP` full-replace xoá `blockWidgetStatus`
...
- [✅ 2026-08-19] Comment lỗi thời ở `packages/assets/src/pages/Onboarding/OnboardingV5/Steps/StepActivate/StepActivate.js:23`
...
- [✅ 2026-08-19] **[P0]** `getCacheKey()` mất `?shop=` sau SPA nav — sửa gốc cho cả 2 cache
...
24. [✅ 2026-08-20] **Rà vùng chạm + mật độ ở 375px**
    ...
    - nhánh `feat/joyxjoy-landing` · commit `fd625cd` (chung với phần số cột)
    - Vùng chạm mở bằng `::before` trong suốt, **không phóng to phần nhìn thấy** — vì ở card 152px
      stepper chỉ còn 9px dư, phóng to thật sẽ tràn card.
    - `--jw-sticky-top` đo header thật lúc mount + on resize, fallback 178px.
    - Mật độ filterbar 375px: **không cần sửa** — ô search vừa đổi thành thu gọn 42px đã giải phóng
      đủ chỗ (chipbar còn 281px ở 375px, 226px ở 320px).
    - Đo trên Chrome thật ở 375px: stepper `36×36 → hit 44×44` · chip `56×44` · mũi tên `34→44` ·
      phân trang `34→44`. Tràn ngang 0/8 bề rộng (1440→320).

- [✅ 2026-08-20] check nhánh feat/portal-preview giúp tôi ở trường hợp khách đã login và chưa có contract nào thì vẫn đang chưa hiển thị preview khi click preview từ admin app?
